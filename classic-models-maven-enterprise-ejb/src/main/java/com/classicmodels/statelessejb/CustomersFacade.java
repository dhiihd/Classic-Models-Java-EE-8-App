...
public class CustomersFacade extends AbstractFacade implements CustomersRemote {
    ...
    public List<BigDecimal> findCustomerCreditLimits(String country) {
        ...
        List<BigDecimal> creditLimitsList = em.createNamedQuery("Customers.findCustomerCreditLimits")
                .setParameter("country", country)
                .getResultList();
        //   Customers customer = customersList.get(0);
        logger.info("creditLimitsList --> " + creditLimitsList);
        //  logger.info("Customer details salesRepEmployeeNumber() --> "+customer.getSalesRepEmployeeNumber());
        return creditLimitsList;
    }
