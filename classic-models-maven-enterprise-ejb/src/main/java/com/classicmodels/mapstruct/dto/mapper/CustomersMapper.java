...
// @Mapping(source = "library.id", target = "libraryId")
 ...
 //   @Mapping(source = "salesRepEmployeeNumber", target = "salesRepEmployeeNumber")
   ...
   // @Mapping(source = "customerNumber", target = "customerNumber")
    ...
    /**
    public Customers fromCustomerNumber(final Integer customerNumber) {
     ...
     default CustomersDTO toEntity(Customers customers) {
        return toEntity(customers, new CycleAvoidingMappingContext());
    }
