...
public class OrderdetailsMapperImpl implements OrderdetailsMapper {
    ...
    @Override
    public Orderdetails toEntity(OrderdetailsDTO orderdetailsDTO, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
    ...
    @Override
    public Collection<Orderdetails> toEntity(Collection<OrderdetailsDTO> orderdetailsDTOs, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        Collection<Orderdetails> target = cycleAvoidingMappingContext.getMappedInstance( orderdetailsDTOs, Collection.class );
        if ( target != null ) {
            return target;
        }
        ...
        Collection<Orderdetails> collection = new ArrayList<Orderdetails>( orderdetailsDTOs.size() );
        cycleAvoidingMappingContext.storeMappedInstance( orderdetailsDTOs, collection );

        for ( OrderdetailsDTO orderdetailsDTO : orderdetailsDTOs ) {
            collection.add( toEntity( orderdetailsDTO, cycleAvoidingMappingContext ) );
        }
    ...
    @Override
    public OrderdetailsDTO toDataObject(Orderdetails orderdetails, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
    ...
    @Override
    public Collection<OrderdetailsDTO> toDataObject(Collection<Orderdetails> orderdetails, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        Collection<OrderdetailsDTO> target = cycleAvoidingMappingContext.getMappedInstance( orderdetails, Collection.class );
        if ( target != null ) {
            return target;
        }
        ...
        Collection<OrderdetailsDTO> collection = new ArrayList<OrderdetailsDTO>( orderdetails.size() );
        cycleAvoidingMappingContext.storeMappedInstance( orderdetails, collection );

        for ( Orderdetails orderdetails1 : orderdetails ) {
            collection.add( toDataObject( orderdetails1, cycleAvoidingMappingContext ) );
        }
