...
public class ProductsMapperImpl implements ProductsMapper {
    ...
    @Override
    public Products toEntity(ProductsDTO productsDTO, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        ...
        products.setOrderdetailsCollection( orderdetailsDTOCollectionToOrderdetailsCollection( productsDTO.getOrderdetailsDTOCollection(), cycleAvoidingMappingContext ) );
    ...
    @Override
    public Collection<Products> toEntity(Collection<ProductsDTO> productsDTOs, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        Collection<Products> target = cycleAvoidingMappingContext.getMappedInstance( productsDTOs, Collection.class );
        if ( target != null ) {
            return target;
        }
        ...
        Collection<Products> collection = new ArrayList<Products>( productsDTOs.size() );
        cycleAvoidingMappingContext.storeMappedInstance( productsDTOs, collection );

        for ( ProductsDTO productsDTO : productsDTOs ) {
            collection.add( toEntity( productsDTO, cycleAvoidingMappingContext ) );
        }
    ...
    @Override
    public ProductsDTO toDataObject(Products products, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        ...
        productsDTO.setOrderdetailsDTOCollection( orderdetailsCollectionToOrderdetailsDTOCollection( products.getOrderdetailsCollection(), cycleAvoidingMappingContext ) );
    ...
    @Override
    public Collection<ProductsDTO> toDataObject(Collection<Products> products, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        Collection<ProductsDTO> target = cycleAvoidingMappingContext.getMappedInstance( products, Collection.class );
        if ( target != null ) {
            return target;
        }
        ...
        Collection<ProductsDTO> collection = new ArrayList<ProductsDTO>( products.size() );
        cycleAvoidingMappingContext.storeMappedInstance( products, collection );

        for ( Products products1 : products ) {
            collection.add( toDataObject( products1, cycleAvoidingMappingContext ) );
        }
    ...
    protected Orders ordersDTOToOrders(OrdersDTO ordersDTO, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
    ...
    protected Orderdetails orderdetailsDTOToOrderdetails(OrderdetailsDTO orderdetailsDTO, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        ...
        orderdetails.setOrders( ordersDTOToOrders( orderdetailsDTO.getOrders(), cycleAvoidingMappingContext ) );
        orderdetails.setProducts( toEntity( orderdetailsDTO.getProducts(), cycleAvoidingMappingContext ) );
    ...
    protected OrdersDTO ordersToOrdersDTO(Orders orders, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
    ...
    protected OrderdetailsDTO orderdetailsToOrderdetailsDTO(Orderdetails orderdetails, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        ...
        orderdetailsDTO.setOrders( ordersToOrdersDTO( orderdetails.getOrders(), cycleAvoidingMappingContext ) );
        orderdetailsDTO.setProducts( toDataObject( orderdetails.getProducts(), cycleAvoidingMappingContext ) );
